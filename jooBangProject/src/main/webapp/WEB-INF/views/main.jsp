	          ...
	          <li>
	            <div class="mainATeg">
	              <a href="/roominfo/${mainRoom.roomNo}">
	                <div>	
	                  <img class="roomImg" src="/images/registImg/${fn:split(mainRoom.roomimages, ',')[0]}" width="260" height="200" />
	                </div>
	        ...
	        <div class="mainItem hotClickBox">
	          <div class="card">
	            <div class="card__images-container">
	              <img class="card__images" src="/images/hot click.png" alt="" />
	            </div>
	          ...
	          <li>
	            <div class="mainATeg">
	              <a href="/roominfo/${mainHotClick.roomNo}">
	                <div>	
	                  <img class="roomImg" src="/images/registImg/${fn:split(mainHotClick.roomimages, ',')[0]}" width="260" height="200" />
	                </div>
	          ...
	          <li>
	            <div class="mainATeg">
	              <a href="/roominfo/${mainRecommend.roomNo}">
	                <div>	
	                  <img class="roomImg" src="/images/registImg/${fn:split(mainRecommend.roomimages, ',')[0]}" width="260" height="200" />
	                </div>
