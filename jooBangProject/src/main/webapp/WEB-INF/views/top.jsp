      ...
      <nav class="navContainer">
        ...
        <div class="mainNavItem navSubMenu">
          <ul class="subMenu">
            ...
            <li class="subMenu" id="subMenuWish"><a href="<c:url value='/wishList/wishListView'/>">찜목록</a></li>
            <c:if test="${not empty sessionScope.sid }">
	            <li class="subMenu" id="subMenuRoom"><a href="<c:url value='/registForm'/>">방올리기</a></li>
		    </c:if>
						
			<c:if test="${empty sessionScope.sid }">
	            <li class="subMenu" id="subMenuRoom"><a href="<c:url value='/member/login'/>">방올리기</a></li>
		    </c:if>
