			...
			<form method="post" action="/regist" enctype="multipart/form-data">
						...
						<div class="questionContainer">
							<div class="buttonContainer">
								<div class="buttonWrapper">
									<input type="radio" id="single" name="roomBuilding"
										value="single"> <label for="single"> 단독주택 </label>
								</div>
								<div class="buttonWrapper">
					...
					<div class="room_info address">
						...
						<div class="questionContainer">
							<div class="Address_SearchBox">
								<span class="Address_AddressInputWrapper"> <input
									class="Address_AddressInput postcodify_postcode" id="zipcode" type="text"
									placeholder="우편 번호" name="roomZipcode" readonly>
								</span>
								<button type="button" class="Button_AddressSearchBtn" id="postcodify_search_button">주소
									검색</button>
							</div>
							<p>
								(지번, 도로명, 아파트명) <br> 예: 청담동 40-17, 학동로 55길 17, 청담 래미안
							</p>
							<span class="Address_AddressInputWrapper"> <input
								class="Address_AddressInput postcodify_address" id="address1" type="text"
								placeholder="주소지" name="roomAddress1" readonly>
							</span> <span class="Address_AddressInputWrapper input_available">
								<input class="Address_AddressInput" id="address2" type="text"
								name="roomAddress2" placeholder="상세 주소">
							</span>
						...
						<div class="questionContainer">
							<div class="countBoxWrap">
								<div class="count_countBox">
									...
									<div class="room_btn">
										<button type="button" class="up_btn" value="+"
											onClick="qtyChange(0,1)">
											<img src='<c:url value="image/expand_circle_down.svg"/>'>
										</button>
										<div class="count_num">
											<input type="text" class="roomQty" name="roomRCount" size="1"
												value="1" readonly>
										</div>
										<button type="button" class="down_btn" value="-"
											onClick="qtyChange(0,-1)">
											<img src='<c:url value="image/expand_circle_down.svg"/>'>
										</button>
									</div>
							...
							<div class="countBoxWrap">
								<div class="count_countBox">
									...
									<div class="room_btn">
										<button type="button" class="up_btn" value="+"
											onClick="qtyChange(1,1)">
											<img src='<c:url value="image/expand_circle_down.svg"/>'>
										</button>
										<div class="count_num">
											<input type="text" class="roomQty" name="roomBCount" size="1"
												value="1" readonly>
										</div>
										<button type="button" class="down_btn" value="-"
											onClick="qtyChange(1,-1)">
							...
							<div class="countBoxWrap">
								<div class="count_countBox">
									...
									<div class="room_btn">
										<button type="button" class="up_btn" value="+"
											onClick="qtyChange(2,1)">
											<img src='<c:url value="image/expand_circle_down.svg"/>'>
										</button>
										<div class="count_num">
											<input type="text" class="roomQty" name="roomLCount" size="1"
												value="1" readonly>
										</div>
										<button type="button" class="down_btn" value="-"
											onClick="qtyChange(2,-1)">
							...
							<div class="countBoxWrap">
								<div class="count_countBox">
									...
									<div class="room_btn">
										<button type="button" class="up_btn" value="+"
											onClick="qtyChange(3,1)">
											<img src='<c:url value="image/expand_circle_down.svg"/>'>
										</button>
										<div class="count_num">
											<input type="text" class="roomQty" name="roomKCount" size="1"
												value="1" readonly>
										</div>
										<button type="button" class="down_btn" value="-"
											onClick="qtyChange(3,-1)">
					...
					<div class="room_info plus">
						...
						<div class="questionContainer">
							<div class="buttonContainer">
								...
								<div class="buttonWrapper">
									<input type="radio" id="no_elevator" name="infoElevator"
										value="no"> <label for="no_elevator"> 없음 </label>
								</div>
								<div class="buttonWrapper">
									<input type="radio" id="yes_elevator" name="infoElevator"
										value="yes"> <label for="yes_elevator"> 있음 </label>
								</div>
								<span class="plustitle">주차</span>
								<div class="buttonWrapper">
									<input type="radio" id="no_parking" name="infoParking"
										value="no"> <label for="no_parking"> 없음 </label>
								</div>
								<div class="buttonWrapper">
					...
					<div class="room_introduce option">
						...
						<div class="questionContainer">
							<div class="buttonContainer">
								...
								<div class="buttonWrapper">
									<input type="checkbox" id="refrigerator" name="basicOption"
										value="refrigerator"> <label for="refrigerator">
										냉장고 </label>
								</div>
								<div class="buttonWrapper">
									<input type="checkbox" id="microwave" name="basicOption"
										value="microwave"> <label for="microwave">
										전자레인지 </label>
								</div>
								<div class="buttonWrapper">
									<input type="checkbox" id="air-conditioner" name="basicOption"
										value="air-conditioner"> <label for="air-conditioner">
										에어컨 </label>
								</div>
								<div class="buttonWrapper">
									<input type="checkbox" id="washing-machine" name="basicOption"
										value="washing-machine"> <label for="washing-machine">
										세탁기 </label>
								</div>
								...
								<div class="buttonWrapper">
									<input type="checkbox" id="internet" name="addtionalOption"
										value="인터넷"> <label for="internet"> 인터넷(Wi-Fi)
									</label>
								</div>
								<div class="buttonWrapper">
									<input type="checkbox" id="TV" name="addtionalOption"
										value="TV"> <label for="TV"> 케이블TV </label>
								</div>
								<div class="buttonWrapper">
									<input type="checkbox" id="gas-range" name="addtionalOption"
										value="가스레인지"> <label for="gas-range"> 가스레인지 </label>
								</div>
								<div class="buttonWrapper">
									<input type="checkbox" id="induction" name="addtionalOption"
										value="인덕션"> <label for="induction"> 인덕션 </label>
								</div>
								<div class="buttonWrapper">
									<input type="checkbox" id="desk" name="addtionalOption"
										value="책상"> <label for="desk"> 책상 </label>
								</div>
								<div class="buttonWrapper">
									<input type="checkbox" id="shoe-closet" name="addtionalOption"
										value="신발장"> <label for="shoe-closet"> 신발장 </label>
								</div>
								<div class="buttonWrapper">
									<input type="checkbox" id="closet" name="addtionalOption"
										value="옷장"> <label for="closet"> 옷장 </label>
								</div>
								<div class="buttonWrapper">
									<input type="checkbox" id="dress-room" name="addtionalOption"
										value="드레스룸"> <label for="dress-room"> 드레스룸 </label>
								</div>
								<div class="buttonWrapper">
									<input type="checkbox" id="balcony" name="addtionalOption"
										value="베란다"> <label for="balcony"> 발코니/베란다 </label>
								</div>
								<div class="buttonWrapper">
									<input type="checkbox" id="management-office"
										name="addtionalOption" value="관리실"> <label
										for="management-office"> 관리실 </label>
								</div>
								<div class="buttonWrapper">
									<input type="checkbox" id="table" name="addtionalOption"
										value="식탁"> <label for="table"> 식탁 </label>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="questionContainer">
							<div class="buttonContainer">
								<div class="title_boxWrap">
									<input class="title_box" name="roomName" type="text"
										placeholder="예시)역까지 5분거리, 혼자 살기 좋은 집">
									<div>
				...
				<div class="room__Box hidden">
					<div class="room_introduce room_description">
						...
						<div class="questionContainer">
							<div class="buttonContainer">
								<input type="file" id="uploadFileMulti" name="uploadFileMulti"
						...
						<div class="questionContainer">
							<div class="buttonContainer">
								<div class="select_box">
									<div class="label">
										<input class="label_input" id="roomLeastPay"
											name="roomLeastPay"> <label for="roomLeastPay">최소
											예약 기간</label>
									</div>
									<ul class="optionList">
						...
						<div class="questionContainer">
							<div class="buttonContainer">
								<div class="textBoxWrapper">
									<span class="payTitle">보증금</span> <input type="text"
										name="roomDeposit"> 원
								</div>
								<div class="textBoxWrapper">
									<span class="payTitle">1주 임대료</span> <input type="text"
										name="roomRent"> 원 / 1주
								</div>
								<div class="textBoxWrapper">
									<span class="payTitle">1주 관리비</span> <input type="text"
										name="roomAdministrationFee"> 원 / 1주
								</div>
							</div>
						</div>
					</div>
				...
				<div class="room__Box hidden">
					<div class="room_pay pay_option">
						...
						<div class="questionContainer">
							<div class="buttonContainer">
								<div class="buttonWrapper">
									<input type="checkbox" id="electric" name="roomPayOption"
										value="electric"> <label for="electric"> 전기 </label>
								</div>
								<div class="buttonWrapper">
									<input type="checkbox" id="gas" name="roomPayOption"
										value="gas"> <label for="gas"> 가스 </label>
								</div>
								<div class="buttonWrapper">
									<input type="checkbox" id="water" name="roomPayOption"
										value="water"> <label for="water"> 수도 </label>
								</div>
								<div class="buttonWrapper">
					...
					<div class="room_pay longterm_discount">
						...
						<div class="questionContainer">
							<div class="buttonContainer">
								...
								<div class="select_box">
									<div class="label">
										<input class="label_input" id="roomDiscount"
											name="roomDiscount"> <label for="roomDiscount">할인
											기준</label>
									</div>
									<ul class="optionList">
										<li class="optionItem" value="1">1주</li>
								...
								<div class="select_box">
									<div class="label">
										<input class="label_input" id="roomDiscountFee"
											name="roomDiscountFee"> <label for="roomDiscountFee">할인
											금액</label>
									</div>
									<ul class="optionList">
