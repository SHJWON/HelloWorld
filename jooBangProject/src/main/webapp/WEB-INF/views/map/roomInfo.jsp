								...
								<div class="InfoBoxCountainer" id="detailInfo">
									<div class="InfoBoxWrapper">
										...
										<div class="InfoBox">
											...
											<div class="InfoContents">
												<span class="InfoTitle Sub">침실 ${room.roomRCount }</span> <span
													class="InfoTitle Sub">화장실 ${room.roomBCount } </span> <span
													class="InfoTitle Sub">거실 ${room.roomLCount } </span> <span
													class="InfoTitle Sub">부엌 ${room.roomKCount }</span>
											</div>
										</div>
										<div class="InfoBox">
								...
								<div class="wishWrapper">
									<div class="room_info">
										...
										<div class="roomInfo2_room">
											<img src="/image/room.png"> <span class="InfoTitle Sub">침실
												${room.roomRCount } |</span> <span class="InfoTitle Sub">화장실
												${room.roomBCount } |</span> <span class="InfoTitle Sub">거실
												${room.roomLCount } |</span> <span class="InfoTitle Sub">부엌
									...
									<div class="host_info">
										...
										<div class="host_infoBtnWrapper">
											<div class="host_contectBtn">연락하기</div>
