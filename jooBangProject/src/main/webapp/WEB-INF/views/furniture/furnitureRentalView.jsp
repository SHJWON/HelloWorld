      ...
      <div id="furnitureFilterView">
        <div class="quickmenu"> <!--가구-->
            <ul class="furnitrueSubMenu">
                 ...
                 <li class="side-menu"><a href="<c:url value='/furniture/rentalWoodView/${1}'/>">가구</a></li><hr>
                 <li class="side-menu"><a href="<c:url value='/furniture/rentalLifeView/${1}'/>">생활가전</a></li><hr>
                 <li class="side-menu"><a href="<c:url value='/furniture/rentalKitchenView/${1}'/>">주방가전</a></li><hr>
                 <li class="side-menu"><a href="<c:url value='/furniture/rentalEnvironmentView/${1}'/>">환경가전</a></li><hr>
                 <li class="side-menu"><a href="<c:url value='/furniture/rentalHealthView/${1}'/>">헬스/뷰티</a></li><hr>  	  
            </ul>
         </div>
        </div>
