     ...
     <div class="wFilter"> <!--찜목록 서브 메뉴-->
        <div class="quickmenu"> 
            <ul class="wishSubMenu">
                 <li class="side-menu"><a href="<c:url value='/board/boardListAll'/>">내가 본 방</a></li><hr>
                 <li class="side-menu"><a href="<c:url value='/board/boardCtgList/${2}'/>">찜한 방</a></li><hr>
                 <li class="side-menu"><a href="<c:url value='/board/boardCtgList/${3}'/>">방 비교하기</a></li><hr>
            </ul>
         </div>
      </div>
